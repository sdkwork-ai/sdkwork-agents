...
```bash
npm install @sdkwork/agents-backend-sdk
# or
yarn add @sdkwork/agents-backend-sdk
# or
pnpm add @sdkwork/agents-backend-sdk
```

## Quick Start

```typescript
import { SdkworkBackendClient } from '@sdkwork/agents-backend-sdk';
