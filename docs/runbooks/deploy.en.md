# Runbook — sdkwork-agents deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-agents-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-agents/bundle`, loads the image, starts
